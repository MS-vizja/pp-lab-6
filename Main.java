...
public class Main {
    public static void main(String[] args) {
        ...
        Worker worker2 = new Worker("Andrzej", 3000, 2);
        Worker worker3 = new Worker("Tomek", 2800, 3);
        Worker worker4 = new Worker("Krzychu", 3200, 4);
        Manager manager = new Manager("Grzesiek", 4000, 5);
